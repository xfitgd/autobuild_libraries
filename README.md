...
Performs native build only for the current system architecture.

Built libraries are installed in `install/freetype/<target>/` directory for each target, including both shared and static libraries.